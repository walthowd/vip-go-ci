...
function vipgoci_run() {
	...
	if (
		...
		print 'Usage: ' . $argv[0] . PHP_EOL .
            ...
            PHP_EOL .
            "\t" . '--dismissed-reviews-repost-comments=BOOL                             When avoid`ing double-posting comments,' . PHP_EOL .
            ...
            "\t" . '                                                                     OAuth 1.0 consumer key, consumer secret, token and ' . PHP_EOL .
            "\t" . '                                                                     token secret needed for hashes-to-hashes HTTP requests' . PHP_EOL .
            ...
            "\t" . '                                                                     ("' . ASPASVIPGOCI_OPTIONS_FILE_NAME . '") placed in root of the repository.' . PHP_EOL .
            PHP_EOL .
